...
import com.devroid.dateconverterlibrary.TimePicker.TimePickerDialog;
import com.devroid.dateconverterlibrary.Utils;
import com.devroid.nepalidateconverter.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements
        View.OnClickListener, DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener, com.devroid.dateconverterlibrary.CalendarView.Calendar.OnDateSetListener {
...
//        mainBinding.calendar.setHighlightedDays(getSampleModelList());
    ...
    public void onClick(View v) {
        ...
        if (checkEditTextParameter()) {
            ...
            } else if (viewId == R.id.bsToAdConvertButton) {

                try {
                    Model engDate = dateConverter.getEnglishDate(yy, mm, dd);

                    String date = engDate.getYear() + " "
                            + getEnglishMonth(engDate.getMonth())
                            + " "
                            + engDate.getDay()
                            + " "
                            + getDayOfWeek(engDate.getDayOfWeek());
